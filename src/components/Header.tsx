    ...
    <header className="border-b border-slate-200 bg-white">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <nav aria-label="ניווט ראשי" className="flex flex-wrap gap-x-6 gap-y-1 pb-3 text-sm font-medium">
          ...
          <Link href="/שיפוץ-דירה" className="text-ink-700 hover:text-brand-600">שיפוץ דירה</Link>
          <Link href="/שיפוץ-אמבטיה" className="text-ink-700 hover:text-brand-600">שיפוץ אמבטיה</Link>
          <Link href="/צביעת-דירה" className="text-ink-700 hover:text-brand-600">צביעת דירה</Link>
          <Link href="/איטום-גגות" className="text-ink-700 hover:text-brand-600">איטום גגות</Link>
        </nav>
      </div>
    </header>
  );
